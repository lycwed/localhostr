...
.directive('inputTagger', function() {
  return {
    require: '^model',
    restrict: 'E',
    scope: {
    ...
    transclude: true,
    templateUrl: 'directives/input-tagger.html',
...
.directive('messagesHandler', function() {
  return {
    restrict: 'E',
    transclude: true,
    scope: {
    ...
    templateUrl: 'directives/messages-handler.html',
    link: function($scope) {
...
.directive('requireData', function() {
